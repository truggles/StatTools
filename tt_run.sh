...
#    for CAT in 0 1 2 3 4; do
#       plotLimits.py ${DATE}{NoScaleGtrEq2,NoScaleEq2}${CAT}.json:exp0 --auto-style # will plot the expected limit comparisons of the channels
